...
| `RELOAD_ONCE_PER_BATCH`    | Send request to `REQ_URL` only once after `WATCH_SERVER_TIMEOUT` or `WATCH_CLIENT_TIMEOUT` seconds. By default request is sent after each received event.                                                                                                                                                                           | false    | `false`                                   | boolean |
